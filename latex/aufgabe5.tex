...
\paragraph{a)} Die Amplitude eines Sinus wird über eine Periode in 20 Werte diskretisiert. Die diskreten Werte erhält durch lineares Abbilden des Sinus auf den \SI{4}{\bit} Wertebereich. Die Berechneten Werte sind in \autoref{tab:sin-wavetable} aufgeführt.
\[
