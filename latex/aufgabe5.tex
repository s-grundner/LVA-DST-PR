...
Da der Lautsprecher sehr leise war, wurde der Dämpfungswiderstand entfernt.

\begin{figure}[h]
    \centering
    \includegraphics[height=5cm]{latex/images/fotos/5_oszi.JPEG}
    \caption{Darstellung des wert diskreten Sinus am Ausgang des DACs}
\end{figure}